...
The repository produces district-level estimates, summary tables by state, and both static and interactive choropleth maps of results.

The published product can be found at this link: **[America’s Child Care Crisis Leaves Many Families Without Access to Licensed Care](https://www.americanprogress.org/article/americas-child-care-crisis-leaves-many-families-without-access-to-licensed-care/)).**
---
