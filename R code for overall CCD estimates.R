...
## Based on existing definition of a child care desert, where at least 3 young children under the age of 5 are vying for a local, available licensed slot

childcare_data <- read_csv("cap_ccaccess_2025_revised_02282026.csv")

## Full data file only available by Data Use Agreement with the Center for American Progress
