...
| Rurality classification | CDC/NCHS Urban-Rural Classification Scheme for Counties | — |
...
| Analysis data (tables and figures) | Authors' analysis, on file with authors | See `data/` folder |
...
- Topics page: [_(https://www.americanprogress.org/series/child-care-deserts/)_]
