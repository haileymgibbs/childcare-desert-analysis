...
## Refers to existing definition for deserts, where there are at least 3 young children vying for a local, available licensed slot

childcare_data <- read_csv("cap_ccaccess_2025_revised_02282026.csv")

## Full data file only available via Data Use Agreement with the Center for American Progress
